...
item_list = query_result['results']['bindings']

print(json.dumps(query_result))

print(query_result)
outfile = open("full_list_of_businesses.json",'w')
outfile.write(json.dumps(query_result))
outfile.close

#outfile = open("full_list_of_businesses_min.json",'w')
#outfile.write(json.dumps(item_list))
#outfile.close
print(str(len(item_list)) + ' items found')
