"""Fetch sparql query to grab newspapers with websites"""
import json
import mkwikidata
...
# along with optional fields "country" (P17) "place of publication" (P291)
# "language of work or name" (P407) and "logo image" (P154)
